...
# Hardcoded fallbacks were removed after a credential leak;
# senders degrade gracefully (log + return False) when unset
# so local dev without SMTP keeps working.
...
def _email_configured():
    ...
    if not EMAIL_ADDRESS or not EMAIL_PASSWORD:
        ...
        print(
            "[Email] EMAIL_ADDRESS/EMAIL_PASSWORD not configured - "
            "skipping send"
        )

...
Adapted from evidence_to_policy_trace/tests/test_basic.py
"""
...
class TestEvidenceToPolicyTrace(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.basic_input = {
            ...
            "clinical_evidence": [
                {
                    "evidence_id": "E-001",
                    "text": "Clinical indication documented for MRI brain scan with headaches",
                    "document_id": "DOC-001",
    ...
    def test_empty_evidence(self):
        ...
        self.assertIn("no clinical evidence", req_result['explanation'].lower())

...
import { ClipboardList, Search, Calendar, Plus, ChevronLeft, ChevronRight } from "lucide-react"
  ...
  const columns = [
    {
      ...
      render: (req) => (
        <div>
          ...
          {req.patient_id && <p className="text-xs text-slate-400 font-mono mt-0.5">{req.patient_id}</p>}
        </div>
      ),
    },
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        icon={ClipboardList}
        actions={[
          <Button key="new" onClick={() => navigate("/new-request")}>

...
export default function SLATimer({
  ...
  let statusColor = "text-blue-700 dark:text-blue-300"

  let bgColor = "bg-blue-100 dark:bg-blue-950/50"
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="w-20 h-20 rounded-full bg-white/20 dark:bg-slate-900/40 backdrop-blur-sm flex items-center justify-center">
      ...
      <div className="bg-white/20 dark:bg-slate-900/40 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-white/20 dark:border-slate-700">
      ...
      <div className="mb-6">
        ...
        <div className="w-full h-3 rounded-full bg-white/30 dark:bg-slate-800 overflow-hidden border border-white/40 dark:border-slate-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white/20 dark:bg-slate-900/40 backdrop-blur-sm rounded-2xl p-4 text-center border border-white/20 dark:border-slate-700">
          ...
          <div
            ...
            className={`mt-6 pt-6 border-t border-white/20 ${
              ...
              status === "expired"
                ...
                ? "bg-red-50/30 dark:bg-red-950/40"

                : "bg-orange-50/30 dark:bg-orange-950/40"
            } rounded-2xl p-5 border border-white/20 dark:border-slate-700`}
          >

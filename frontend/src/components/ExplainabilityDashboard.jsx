...
export default function ExplainabilityDashboard({
  ...
  if (!result) {
    ...
    return (
      ...
      <div className="bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-900/60 rounded-3xl p-8 text-center">

        <Brain className="text-blue-800 dark:text-blue-400 mx-auto mb-4" size={40} />
  ...
  return (
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-100 dark:border-slate-700 p-8">

        <div className="flex items-center gap-4 mb-8">

          <div className="w-16 h-16 rounded-2xl bg-blue-100 dark:bg-blue-900/40 flex items-center justify-center">

            <TrendingUp className="text-blue-800 dark:text-blue-400" size={32} />

          </div>

          <div>

            <h2 className="text-3xl font-bold text-blue-950 dark:text-blue-400">
            ...
            <div className="relative w-32 h-32">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-4xl font-extrabold text-blue-950 dark:text-blue-400">

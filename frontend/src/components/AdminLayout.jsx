...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex relative overflow-x-clip">
      <ParticleBackground />
      ...
      <aside className={`fixed lg:sticky lg:top-0 lg:self-start lg:h-screen inset-y-0 left-0 z-50 w-72 bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border-r border-blue-100 dark:border-slate-700 flex flex-col transition-all duration-300 ${

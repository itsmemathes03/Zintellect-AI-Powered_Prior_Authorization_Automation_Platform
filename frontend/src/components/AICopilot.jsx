    ...
    <>
...

      {
        ...
        isOpen && (
          ...
          <div className="fixed bottom-8 right-8 w-96 max-h-[600px] bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-700 flex flex-col z-50 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-5 bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
...

              {
                ...
                loading && (
                  ...
                  <div className="flex gap-3 justify-start">
                    ...
                    <div className="bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white px-5 py-3 rounded-2xl rounded-bl-none flex items-center gap-2">
            ...
            <div className="border-t border-slate-200 dark:border-slate-700 p-4 bg-white dark:bg-slate-900">
              ...
              <div className="flex gap-3">
                ...
                <input
                  ...
                  className="flex-1 border border-slate-300 dark:border-slate-700 rounded-2xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm bg-white dark:bg-slate-800 text-slate-900 dark:text-white"
                />

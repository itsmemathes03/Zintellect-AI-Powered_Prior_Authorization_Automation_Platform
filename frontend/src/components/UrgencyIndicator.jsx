...
export default function UrgencyIndicator({
  ...
  const urgencyConfig = {
    ...
    critical: {
      ...
      color: "bg-red-100 text-red-700 border-red-300 dark:bg-red-950/40 dark:text-red-300 dark:border-red-900/50",
    ...
    high: {
      ...
      color: "bg-orange-100 text-orange-700 border-orange-300 dark:bg-orange-950/40 dark:text-orange-300 dark:border-orange-900/50",
    ...
    medium: {
      ...
      color: "bg-yellow-100 text-yellow-700 border-yellow-300 dark:bg-yellow-950/40 dark:text-yellow-300 dark:border-yellow-900/50",
    ...
    low: {
      ...
      color: "bg-green-100 text-green-700 border-green-300 dark:bg-green-950/40 dark:text-green-300 dark:border-green-900/50",
      ...
      <div className="flex items-start gap-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div className="px-4 py-2 rounded-full bg-white/30 dark:bg-slate-900/40 backdrop-blur-sm text-sm font-bold">

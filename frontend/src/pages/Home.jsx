    ...
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg border border-slate-100 dark:bg-slate-900 dark:border-slate-700">

            <div className="w-16 h-16 rounded-2xl bg-blue-100 flex items-center justify-center dark:bg-blue-900/30">
            ...
            <p className="text-gray-500 mt-4 leading-8 dark:text-slate-400">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg border border-slate-100 dark:bg-slate-900 dark:border-slate-700">
            ...
            <div className="w-16 h-16 rounded-2xl bg-emerald-100 flex items-center justify-center dark:bg-emerald-900/30">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg border border-slate-100 dark:bg-slate-900 dark:border-slate-700">
            ...
            <div className="w-16 h-16 rounded-2xl bg-purple-100 flex items-center justify-center dark:bg-purple-900/30">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 text-lg mt-5 dark:text-slate-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-slate-100 hover:-translate-y-2 transition-all duration-300 dark:bg-slate-900 dark:border-slate-700">

            <div className="w-20 h-20 rounded-3xl bg-blue-100 flex items-center justify-center dark:bg-blue-900/30">
            ...
            <h2 className="text-3xl font-bold mt-8 text-slate-900 dark:text-white">

              Insurance Provider

            </h2>

            <p className="text-gray-500 mt-5 leading-8 text-lg dark:text-slate-400">
            ...
            <ul className="mt-8 space-y-3 text-gray-600 dark:text-slate-400">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-slate-100 hover:-translate-y-2 transition-all duration-300 dark:bg-slate-900 dark:border-slate-700">
            ...
            <div className="w-20 h-20 rounded-3xl bg-emerald-100 flex items-center justify-center dark:bg-emerald-900/30">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-slate-100 hover:-translate-y-2 transition-all duration-300 dark:bg-slate-900 dark:border-slate-700">
            ...
            <div className="w-20 h-20 rounded-3xl bg-purple-100 flex items-center justify-center dark:bg-purple-900/30">

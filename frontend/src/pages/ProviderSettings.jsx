    ...
    <div className="max-w-3xl space-y-8">
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900/60 dark:to-teal-900/60 flex items-center justify-center shadow-inner">
          <Settings className="text-emerald-700 dark:text-emerald-300" size={24} />
        </div>
        <div>
          <h1 className="text-3xl font-extrabold text-emerald-950 dark:text-white">Profile Settings</h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm">Manage your provider profile information</p>
        </div>
      </div>

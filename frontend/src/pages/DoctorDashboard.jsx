    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <p className="text-cyan-950 text-xl font-bold">Loading dashboard...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <div className="inline-flex items-center gap-3 bg-cyan-50 border border-cyan-100 px-4 py-2 rounded-full mb-4">
            <Sparkles size={16} className="text-cyan-600" />
            <span className="text-sm font-semibold text-cyan-800">Doctor Dashboard</span>
          </div>
          <h1 className="text-4xl font-extrabold text-cyan-950">Welcome, Dr. {doctorName}</h1>
          <p className="text-slate-500 mt-2 text-lg">Manage your prior authorization requests and patients.</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-cyan-100/50 p-8 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300">
          <div className="flex items-center justify-between mb-6">
            <div>
              <p className="text-slate-500 text-sm font-semibold">Total Requests</p>
              <h2 className="text-5xl font-extrabold text-cyan-950 mt-3">{stats?.total_requests || 0}</h2>
            </div>
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-100 to-sky-100 flex items-center justify-center shadow-inner">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-cyan-100/50 p-8 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300">
          <div className="flex items-center justify-between mb-6">
            <div>
              <p className="text-slate-500 text-sm font-semibold">Patients</p>
              <h2 className="text-5xl font-extrabold text-cyan-950 mt-3">{stats?.total_patients || 0}</h2>
            </div>
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-100 to-sky-100 flex items-center justify-center shadow-inner">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-cyan-100/50 p-8 hover:shadow-2xl transition-all duration-300">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-cyan-100 to-sky-100 flex items-center justify-center shadow-inner">
              <BarChart3 className="text-cyan-700" size={24} />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-cyan-950">Request Status</h2>
        ...
        <div className="xl:col-span-2 bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-cyan-100/50 p-8 hover:shadow-2xl transition-all duration-300">
          <div className="flex items-center gap-4 mb-8">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-cyan-100 to-sky-100 flex items-center justify-center shadow-inner">
              <Brain className="text-cyan-700" size={24} />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-cyan-950">Recent Requests</h2>
          ...
          {recentRequests.length === 0 ? (
            <div className="text-center py-12 bg-slate-50/80 rounded-3xl border border-slate-200">
              ...
              <h3 className="text-xl font-bold text-cyan-950 mt-6">No Requests Yet</h3>
              <p className="text-slate-500 mt-3">Submit your first prior authorization request to get started.</p>
              <button
                onClick={() => navigate("/doctor-dashboard/requests")}
            ...
            <div className="space-y-4">
              {recentRequests.map((req) => (
                <div key={req.id} className="border border-slate-200 rounded-2xl p-5 hover:shadow-lg transition-all hover:border-cyan-200 hover:scale-[1.01]">

...
from .schemas import EvidenceItem, PolicyRequirement, MatchStatus, EvidenceMatch, RequirementResult
...
class EvidenceToPolicyEngine:
    ...
    def _match_requirement_to_evidence(self, requirement: PolicyRequirement, evidence_items: List[EvidenceItem]) -> Tuple[List[EvidenceMatch], MatchStatus, float, str]:
        ...
        for evidence in evidence_items:
            ...
            contradiction_indicators = ['no', 'not', 'negative', 'absent', 'denies', 'rule out', 'without']
            req_has_negation = any(indicator in requirement_text for indicator in contradiction_indicators)
            evidence_has_negation = any(indicator in evidence_text for indicator in contradiction_indicators)

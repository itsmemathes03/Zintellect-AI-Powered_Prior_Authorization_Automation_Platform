...
class TestEvidenceToPolicyEdgeCases(unittest.TestCase):
    ...
    def test_duplicate_evidence(self):
        ...
        input_data = {
            ...
            "policy": {
                "requirements": [
                    {
                        "requirement_id": "REQ-001",
                        "description": "Symptom must be documented"
                    }
                ]
            },
            "clinical_evidence": [
                ...
                {
                    "evidence_id": "E-002",
                    "text": "Patient has headache",  # Duplicate text
                    "document_id": "DOC-001",
                    "document_name": "doc.pdf",
                    "page": 1,
                    "confidence": 0.85
        ...
        self.assertLessEqual(len(req_result['evidence']), 2)  # Could be 1 or 2 depending on deduplication
